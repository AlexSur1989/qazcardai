...
- `assets/photos/*.jpg` — иллюстрации для карточек «Возможности», CTA и «Для кого» (сжатые JPEG; при необходимости замените на свои снимки, сохранив имена или обновив пути в `index.html`)
