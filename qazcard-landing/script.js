...
const LINKS = {
  ...
  registerAiModels: `${APP_ORIGIN}/register?next=/dashboard/models`,
  registerVideo: `${APP_ORIGIN}/register?next=/dashboard/models`,
  registerImage: `${APP_ORIGIN}/register?next=/dashboard/models`,
