...
import { cardBuilderGenerateSlideBodySchema } from "@/server/api/product-card-card-builder-validation";
import { generateCardBuilderSingleSlide } from "@/server/services/productCardCardBuilder";
...
export async function POST(req: Request, ctx: Ctx) {
  ...
  const result = await generateCardBuilderSingleSlide({
    userId,
    projectId: id,
